...
pygame.display.set_caption("Gradational Slightshot Effect")
...
PLANET = pygame.transform.scale(
    pygame.image.load("jupiter.png"), (PLANET_SIZE * 2, PLANET_SIZE * 2)
)
...
def main():
    ...
    while running:
        ...
        for obj in objects[:]:
            obj.draw()
            obj.move(planet)
            off_screen = obj.x < 0 or obj.x > WIDTH or obj.y > HEIGHT
